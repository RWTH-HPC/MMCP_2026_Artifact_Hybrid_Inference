# Script to remove all accesses to the m_bndId member variable of the
# cell types inside ZFS.
#
# The following cases are identified (see also matchers below):
# - m_cells->a[ ... ].m_bndId
# - cells[ ... ].m_bndId
# - inside_cells->a[ ... ].m_bndId
# - cpu_cells->a[ ... ].m_bndId
#
...
end_pId_re = "\]\s*\.m_bndId\\b"
end_pId_ggp_re = "\]\s*\.m_bndId\)"
matchers = [
...
tokens = [
            # # matches bndId in grid files (shadowing)
            # {'pattern': r"\bbndId\b",
            #  'replacement': "bndId_",
            #  'ftype': ['grid'],
            # }
