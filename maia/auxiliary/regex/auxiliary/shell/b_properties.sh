...
# Old and new name
OLDNAME="b_properties"
NEWNAME="a_hasProperty"
...
# if inlist $BASE $GRID_FILES; then
#   CONTENT=$(regex "$CONTENT" "$PREFIX" "$SUFFIX" "$REPLACE")
# fi
# 
...
# if inlist $BASE $M_BLOCKPTR_FILES; then
#   CONTENT=$(regex "$CONTENT" "$PREFIX" "$SUFFIX" "$REPLACE")
# fi
# 
# # For cells/m_cells
...
# if inlist $BASE $M_BLOCK_FILES; then
#   CONTENT=$(regex "$CONTENT" "$PREFIX" "$SUFFIX" "$REPLACE")
# fi
# 
# # Specific replacements for files with block ptr
# REPLACE="\&blockPtr->${NEWNAME}(\2, 0)"
# if inlist $BASE $BLOCKPTR_FILES; then
#   CONTENT=$(regex "$CONTENT" "$PREFIX" "$SUFFIX" "$REPLACE")
# fi
# 
# # Replacements for all other files
