...
#ifndef ACAOBSERVERDATACOLLECTOR_H_
#define ACAOBSERVERDATACOLLECTOR_H_
...
template <MInt nDim>
class ObserverDataCollector : public maia::container::Container<ObserverDataCollector<nDim>, Invalid> {
  // Necessary for CRTP
 ...
 private:
  ...
  static constexpr MInt s_maxNoVars = 10; // TODO labels:ACA
...
template <MInt nDim>
MFloat& ObserverDataCollector<nDim>::observerCoordinates(const MInt id) {
...
#error Missing implementation for structure-of-arrays memory layout.
  ...
  return m_observerCoordinates[id * nDim];
}
/// Accessor for surface element coordinates (const version).
template <MInt nDim>
MFloat ObserverDataCollector<nDim>::observerCoordinates(const MInt id) const {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
...
/// Accessor for surface element coordinates (const version).
template <MInt nDim>
MFloat ObserverDataCollector<nDim>::observerCoordinates(const MInt id, const MInt component) const {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
  ENSURE_VALID_ID_ACCESSOR(id);
  return m_observerCoordinates[id * nDim + component];
}


/// Accessor for variables (return a reference to the start of the given variable in memory).
template <MInt nDim>
MFloat& ObserverDataCollector<nDim>::variables(const MInt id, const MInt var) {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
...
template <MInt nDim>
MFloat& ObserverDataCollector<nDim>::variables(const MInt id, const MInt var, const MInt sample) {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
...
template <MInt nDim>
MFloat ObserverDataCollector<nDim>::variables(const MInt id, const MInt var, const MInt sample) const {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
...
template <MInt nDim>
MFloat& ObserverDataCollector<nDim>::complexVariables(const MInt id, const MInt var) {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
...
/// Accessor for complex variables.
template <MInt nDim>
MFloat& ObserverDataCollector<nDim>::complexVariables(const MInt id, const MInt var, const MInt sample,
...
template <MInt nDim>
void ObserverDataCollector<nDim>::invalidate(const MInt begin, const MInt end) {
// Prevent accidental compilation without support for SoA layout
#ifdef ACACOLLECTOR_SOA_MEMORY_LAYOUT
#error Missing implementation for structure-of-arrays memory layout.
#endif
  ...
  fill_invalid(m_observerCoordinates, begin, end, nDim);
...
template <MInt nDim>
template <class Functor, class T>
void ObserverDataCollector<nDim>::rawCopyGeneric(Functor&& c, const T& source, const MInt begin, const MInt end,
...
#error Missing implementation for structure-of-arrays memory layout.
  ...
  // Observer coordinates
  copyData(source.m_observerCoordinates, m_observerCoordinates, c, begin, end, destination, nDim);
